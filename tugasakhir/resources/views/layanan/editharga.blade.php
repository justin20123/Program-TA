...
<form action="{{ route('harga.update', $harga->id) }}" method="post">
  ...
  <div class="h3 px-4 py-2">
    <div class="form-group">
      ...
      <input type="number"
        class="form-control" name="max" id="" aria-describedby="helpId" placeholder="" value="{{$harga->jumlah_cetak_maksimum}}">
    </div>
</div>
  <div class="h3 px-4 py-2">
    <div class="form-group">
      ...
      <input type="number"
        class="form-control" name="min" id="" aria-describedby="helpId" placeholder="" value="{{$harga->jumlah_cetak_minimum}}">
    </div>
</div>
  <div class="h3 px-4 py-2">
    <div class="form-group">
      ...
      <input type="number"
        class="form-control" name="harga" id="" aria-describedby="helpId" placeholder="" value="{{$harga->harga_satuan}}">
    </div>
</div>
