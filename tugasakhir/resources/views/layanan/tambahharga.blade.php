...
<form action="{{ route('harga.store') }}" method="post">
  ...
  <div class="h3 px-4 py-2">
    <div class="form-group">
      ...
      <input type="number"
        class="form-control" name="max" id="" aria-describedby="helpId" placeholder="">
    </div>
</div>
  <div class="h3 px-4 py-2">
    <div class="form-group">
      ...
      <input type="number"
        class="form-control" name="min" id="" aria-describedby="helpId" placeholder="">
    </div>
</div>
  <div class="h3 px-4 py-2">
    <div class="form-group">
      ...
      <input type="number"
        class="form-control" name="harga" id="" aria-describedby="helpId" placeholder="">
    </div>
</div>
