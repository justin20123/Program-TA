...
@endsection
@section('menu')
<div id="loading" class="d-flex align-items-center justify-content-center" style="height: 100vh; display: flex;">
                        ...
                        <div class="row no-gutters">
                          ...
                          <div class="col-md-8">
                            <div class="card-body">
                              ...
                              <p class="card-text font-weight-bold">Rp. ${vendors[i].hargamin}-${vendors[i].hargamaks} <small>/${vendors[i].satuan} - ${vendors[i].layanan}</small></p>
    ...
    async function pageLoad(idlayanan = 1) {
        ...
        try {
            ...
            statusTerdekat = await pageLoadTerdekat(latitude, longitude);   
             if (statusDropDown == "done" && statusLayananTerdekat == "done" && statusUntukAnda == "done" && statusTerdekat == "done") {
